  ...
  <colgroup>
    ...
    <tbody>     
      <tr>      
        ...
        <td><input name="productName"list="productNameList" value={form.productName} onChange={handleChange} 
        /></td>
        <td><input name="spec" value={form.spec} onChange={handleChange}
        /></td>
        <td><input name="quantity" value={form.quantity} onChange={handleChange} style={{width:'50px'}} /></td>
        <td><input
          name="unitPrice" 
